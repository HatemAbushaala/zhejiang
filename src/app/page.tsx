...
export default function Home() {
  ...
  const prevSlide = () => setActiveSlide((p) => (p - 1 + PRODUCTS.length) % PRODUCTS.length)
  const nextSlide = () => setActiveSlide((p) => (p + 1) % PRODUCTS.length)
    ...
    <div className="flex flex-col min-h-screen overflow-x-hidden" dir="ltr">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
          <a href="#home" className="flex items-center gap-2">
            ...
            />
            <span className="font-bold text-gray-900 text-lg">Zhejiang Jiemai</span>
          </a>
      ...
      <section id="home" className="relative flex items-center justify-center min-h-screen bg-gray-900 text-white overflow-hidden pt-16">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <p className="text-orange-400 uppercase tracking-widest text-sm font-semibold mb-4">Professional Industrial Tools</p>
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold leading-tight mb-6">
            GERMA Heavy-Duty
            <br />
            <span className="text-orange-400">Chisels &amp; Drill Bits</span>
          </h1>
          <p className="text-xl sm:text-2xl font-light text-gray-200 mb-4">Built for Strength, Engineered for Precision</p>
          <p className="text-gray-300 max-w-2xl mx-auto mb-10 leading-relaxed">
            Zhejiang Jiemai specializes in electric hammer chisels, pneumatic components, and industrial drill bits — manufactured with premium
            imported spring steel and hardened alloy tips for superior performance.
          </p>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-orange-500 uppercase tracking-widest text-xs font-semibold mb-3">Who We Are</p>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-6">About Zhejiang Jiemai</h2>
              <p className="text-gray-600 leading-relaxed mb-4">
                Zhejiang Jiemai is a leading manufacturer and exporter of standard and heavy-duty demolition attachments, operating under the trusted{" "}
                <strong>GERMA</strong> and <strong>GERMA</strong> brands. We serve construction professionals and industrial distributors across the
                globe.
              </p>
              <p className="text-gray-600 leading-relaxed mb-4">
                Our products leverage advanced metallurgy — combining high-carbon spring steel with precision heat treatment — to deliver exceptional
                torque resistance, fatigue life, and impact energy transfer in the most demanding construction and excavation environments.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Based in Yiwu, China, we combine scale manufacturing with meticulous quality control to supply reliable, cost-effective tooling
                solutions to wholesale partners worldwide.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="grid md:grid-cols-2">
                <div className="relative h-64 md:h-80">
                  <Image src={PRODUCTS[activeSlide].image} alt={PRODUCTS[activeSlide].title} fill className="object-cover" />
                </div>
                <div className="p-8 flex flex-col justify-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">{PRODUCTS[activeSlide].title}</h3>
                  <p className="text-gray-600 leading-relaxed mb-8">{PRODUCTS[activeSlide].description}</p>
                  <a
                    href="#contact"
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-4">
                  <ContactRow icon={<PhoneIcon />} label="Phone" value="+1 39 7016 7166" href="tel:+13970167166" />
                  <ContactRow icon={<EmailIcon />} label="Email" value="270027768@qq.com" href="mailto:270027768@qq.com" />
                  <ContactRow icon={<LocationIcon />} label="Address" value="Gate 27, Zone 2, Yiwu, China" />
                  <ContactRow
              ...
              <div className="bg-gray-800 rounded-2xl p-6">
                <p className="text-gray-300 text-sm leading-relaxed">
                  We work with wholesale distributors, construction firms, and OEM partners worldwide. Reach out to discuss bulk pricing, custom
                  branding, or technical specifications.
                </p>
              </div>
            </div>
      ...
      <footer className="bg-gray-950 text-gray-400 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid sm:grid-cols-3 gap-8 mb-8">
            <div>
              ...
              <p className="text-sm leading-relaxed">
                Premium industrial tooling manufacturer under the GERMA and GERMA brands. Serving global wholesale partners from Yiwu, China.
              </p>
            </div>
          ...
          <div className="border-t border-gray-800 pt-6 text-center text-xs text-gray-500">&copy; 2026 Zhejiang Jiemai. All rights reserved.</div>
        </div>
      </footer>
    </div>
  )
